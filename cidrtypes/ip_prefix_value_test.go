...
func TestIPPrefixStringSemanticEquals(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"semantically equal - case insensitive": {
			currentIpPrefix: cidrtypes.NewIPPrefixValue("2001:0DB8:0000:0000:0008:0800:0200C:417A/60"),
			givenIpPrefix:   cidrtypes.NewIPPrefixValue("2001:0db8:0000:0000:0008:0800:0200c:417a/60"),
			expectedMatch:   true,
		},
